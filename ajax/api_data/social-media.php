    	...
    	"data": [
    		{
    			...
    			"min": "100",
    			"max": "10000",
    			"catatan": "Masukan Username Tanpa @ Example : example_23"
    		},
    		{
    			"sid": "2",
            ...
            <div role="tabpanel" class="tab-pane fade" id="order">
                ...
                <div class="table-responsive">
                	<table class="table table-bordered">
                		...
                		<tr>
                			<td>layanan</td>
                			<td>ID Layanan, Dapat Dilihat Di <a href="<?php echo $config['web']['url']; ?>price/social-media" target="blank">Daftar Layanan</a></td>
                		</tr>
                		<tr>
                			<td>target</td>
