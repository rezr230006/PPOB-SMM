...
?>
                                <tr>
                                    ...
                                    <td><span class="btn btn-<?php echo $label; ?> btn-elevate btn-pill btn-elevate-air btn-sm"><?php echo $data_depo['status']; ?></span>
 								    <td align="center">
								        <a href="<?php echo $config['web']['url'] ?>deposit/invoice?kode_deposit=<?php echo $data_depo['kode_deposit']; ?>" class="btn btn-primary btn-elevate btn-circle btn-icon"><i class="flaticon-eye"></i></a>
								    </td>
                                </tr>   
<?php } ?>
                            </tbody>
