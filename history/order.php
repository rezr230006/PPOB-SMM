...
?>
                                            <tr>
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <button data-toggle="tooltip" title="Copy Keterangan" class="btn btn-primary btn-sm" type="button" onclick="copy_to_clipboard('keterangan-<?php echo $data_pesanan['oid']; ?>')"><i class="fas fa-copy text-white"></i></button>
                                                </div>
                                                </td>
                                                <td>Rp <?php echo number_format($data_pesanan['harga'],0,',','.'); ?></td>
                                                <td><span class="btn btn-<?php echo $label; ?> btn-elevate btn-pill btn-elevate-air btn-sm"><?php echo $data_pesanan['status']; ?></span></td>
