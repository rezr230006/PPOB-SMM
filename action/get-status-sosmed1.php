...
$ch = curl_init();
        ...
        if ($result['status'] == true) {
	      ...
	      if ($sn == "Success") {
	        ...
	        $update_order1 = $conn->query("UPDATE semua_pembelian SET status = '".$status."' WHERE id_pesan = '$o_oid'");
    	    ...
    	    if ($update_order1 == TRUE) {
    	        echo "===============<br>Berhasil Menampilkan Data semua pembelian<br><br>ID Pesanan : $o_oid<br>Remains : $remains<br>Status : $status<br>===============<br>";
    	    } else {
    	        echo "Gagal Menampilkan Data semua pembelian.<br />";
    	    }		
