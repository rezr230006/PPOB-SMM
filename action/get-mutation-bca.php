...
$total = number_format($val[3],0,'','');
    ...
    $insert = $conn->query("INSERT INTO mutasi_bca VALUES ('', '$tipe','$keterangan','$total','$tanggal','BCA')");
    $insert = $conn->query("UPDATE mutasi SET status = 'READ' WHERE jumlah = '$total'");
    if ($insert == TRUE) {
