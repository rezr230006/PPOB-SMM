...
require '../library/session_user.php';
	    ...
	    if (isset($_POST['pesan'])) {
		    ...
		    if (mysqli_num_rows($cek_layanan) == 0) {
		        ...
		        $_SESSION['hasil'] = array('alert' => 'danger', 'pesan' => 'Ups, Sepertinya Tagihan Kamu Sudah Ada Silakan Cek Riwayat Pesanan Kamu.<script>swal("Ups Gagal!", "Tagihan Kamu Belum Dibayar.", "error");</script>');
        ...
        <div class="row">
	        <div class="col-lg-7">
		        <div class="kt-portlet">
                    ...
                    $cek_layanan = $conn->query("SELECT * FROM layanan_pascabayar WHERE kategori = 'BPJS KESEHATAN' AND status = 'Normal' ORDER BY layanan ASC");
