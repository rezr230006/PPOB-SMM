...
require '../library/session_login_admin.php';
        ...
        if (isset($_POST['ubah'])) {
            ...
            $CheckData = $conn->query("SELECT * FROM setting_koin_didapat WHERE id = '$GetID'");

            if ($CheckData->num_rows == 0) {
                $_SESSION['hasil'] = array('alert' => 'danger', 'pesan' => 'Ups, Data Tidak Di Temukan.');
            } else {

                if ($conn->query("UPDATE setting_koin_didapat SET rate = '$PostRate', status = '$PostStatus' WHERE id = '$GetID'") == true) {
                    $_SESSION['hasil'] = array('alert' => 'success', 'pesan' => 'Sip, Pengaturan Koin Didaptkan Berhasil Di Ubah.');
                } else {
        ...
        <div class="kt-subheader kt-grid__item" id="kt_subheader">
	        <div class="kt-container ">
	            <div class="kt-subheader__main">
                    <h3 class="kt-subheader__title">Pengaturan Koin Didapatkan</h3>
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <span class="kt-subheader__breadcrumbs-separator"></span>
                        <a href="#" class="kt-subheader__breadcrumbs-link">Pengaturan Koin Didapatkan</a>
	                </div>
	            </div>
	        </div>
        </div>
		        ...
		        <div class="kt-portlet">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
                            ...
                            <tbody>
<?php
    $CallDB_Koin = $conn->query("SELECT * FROM setting_koin_didapat ORDER BY id DESC"); // edit
