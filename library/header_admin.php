...
<head>
    ...
    <!-- Start CSS -->
    <link href="<?php echo $config['web']['url'] ?>assets/plugins/global/plugins-2.bundle.css?v<?php echo $versi; ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo $config['web']['url'] ?>assets/css/style-2.bundle.css?v<?php echo $versi; ?>" rel="stylesheet" type="text/css" />
    <!-- End CSS -->
	...
	<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed">
        <div class="kt-header-mobile__logo">
	        <a href="<?php echo $config['web']['url'] ?>">
		         <img alt="<?php echo $data['short_title']; ?>" src="<?php echo $config['web']['url'] ?>assets/media/logos/favicon.png" style="width: auto; height: 50px;"/>
	        </a>
        </div>
	...
	<div class="kt-header__brand   kt-grid__item" id="kt_header_brand">
	    <a class="kt-header__brand-logo" href="<?php echo $config['web']['url'] ?>">
	        <img alt="<?php echo $data['short_title']; ?>" src="<?php echo $config['web']['url'] ?>assets/media/logos/webkmpanelblack.png" class="kt-header__brand-logo-default" style="width: auto; height: 50px;"/>
	        <img alt="<?php echo $data['short_title']; ?>" src="<?php echo $config['web']['url'] ?>assets/media/logos/logo.png" class="kt-header__brand-logo-sticky" style="width: auto; height: 50px;"/>
	    </a>		
	</div>
	<!-- End Brand -->
	...
	<div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background-image: url(<?php echo $config['web']['url'] ?>assets/media/bg/bg-2.png)">
        <div class="kt-user-card__avatar">
            <img class="kt-hidden" alt="Profile" src="<?php echo $config['web']['url'] ?>assets/media/icon/user.jpg" />
		    ...
		    <ul class="kt-menu__nav ">
			    ...
			    <li class="kt-menu__item" aria-haspopup="true">
			        <a href="<?php echo $config['web']['url'] ?>admin/daftar-isi-saldo" class="kt-menu__link">
			            ...
			            <span class="kt-menu__link-text">Daftar Deposit</span>
			        </a>
			    </li>
			    <li class="kt-menu__item" aria-haspopup="true">
			    ...
			    <li class="kt-menu__item" aria-haspopup="true">
			        <a href="<?php echo $config['web']['url'] ?>admin/daftar-pembayaran-isi-saldo" class="kt-menu__link">
			            <i class="kt-menu__link-icon fa fa-credit-card"></i>
			            <span class="kt-menu__link-text">Pembayaran Deposit</span>
			        </a>
			    </li>
			    <li class="kt-menu__item" aria-haspopup="true">
